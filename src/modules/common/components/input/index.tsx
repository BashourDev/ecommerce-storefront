      ...
      <div>
        <div className="relative z-0 w-full text-base-regular">
          ...
          <label
            ...
            className={clsx(
              `mx-3 px-1 transition-all absolute duration-300 w-fit top-3 -z-1 ${locale === "en"?"left-0":"right-0"} text-gray-500`,
              {
          ...
          {type === "password" && (
            <button
              ...
              className={`text-gray-400 px-4 focus:outline-none transition-all duration-150 outline-none focus:text-gray-700 absolute ${locale === "en"?"right-0":"left-0"} top-3`}
            >
